...
hist(movies_dataset$runtime)
hist(movies_dataset$gender)
hist(movies_dataset$country_)

count(movies_cast_gender, gender_str)
count(movies_cast_gender, genre)
count(movies_cast_gender, rating)

movies_cast_gender %>% group_by(director) %>% summarise(count_directors = n()) %>% arrange(desc(count_directors))
