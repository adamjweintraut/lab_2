...
netflix_rating_male <- netflix_gender_ratio[netflix_gender_ratio$gender == 'Male',]

#All years
scatterplot(netflix_rating_male$gender_rato_percentage, netflix_rating_male$tomatometer_rating)

#between years 2015 and 2020

netflix_rating_male_2015_to_2020 <- netflix_rating_male[netflix_rating_male$release_year >= 2015,]
scatterplot(netflix_rating_male_2015_to_2020$gender_rato_percentage, netflix_rating_male_2015_to_2020$tomatometer_rating)


#between years 2010 and 2015

netflix_rating_male_2010_to_2015 <- netflix_rating_male[
  (netflix_rating_male$release_year >= 2010) & (netflix_rating_male$release_year < 2015),]

scatterplot(netflix_rating_male_2010_to_2015$gender_rato_percentage, netflix_rating_male_2010_to_2015$tomatometer_rating)


#between years 2005 and 2010

netflix_rating_male_2005_to_2010 <- netflix_rating_male[
  (netflix_rating_male$release_year >= 2005) & (netflix_rating_male$release_year < 2010),]

scatterplot(netflix_rating_male_2005_to_2010$gender_rato_percentage, netflix_rating_male_2005_to_2010$tomatometer_rating)


#between years 2000 and 2005

netflix_rating_male_2000_to_2005 <- netflix_rating_male[
  (netflix_rating_male$release_year >= 2000) & (netflix_rating_male$release_year < 2005),]

scatterplot(netflix_rating_male_2000_to_2005$gender_rato_percentage, netflix_rating_male_2000_to_2005$tomatometer_rating)
...
# All years
ggplot(data=netflix_rating_male, aes(x=gender_rato_percentage, y=tomatometer_rating, color=rating)) +
  geom_point()+
  geom_smooth(method='lm', formula=y~x)+
  labs(title="Male cast-ratio vs RT rating: all years", x="male cast-ratio", y="RT rating")

#between years 2015 and 2020
ggplot(data=netflix_rating_male_2015_to_2020, aes(x=gender_rato_percentage, y=tomatometer_rating, color=rating)) +
  geom_point()+
  geom_smooth(method='lm', formula=y~x)+
...
#between years 2010 and 2015
ggplot(data=netflix_rating_male_2010_to_2015, aes(x=gender_rato_percentage, y=tomatometer_rating, color=rating)) +
  geom_point()+
  geom_smooth(method='lm', formula=y~x)+
...
#between years 2005 and 2010
ggplot(data=netflix_rating_male_2005_to_2010, aes(x=gender_rato_percentage, y=tomatometer_rating, color=rating)) +
  geom_point()+
  geom_smooth(method='lm', formula=y~x)+
...
#between years 2000 and 2005
ggplot(data=netflix_rating_male_2000_to_2005, aes(x=gender_rato_percentage, y=tomatometer_rating, color=rating)) +
  geom_point()+
  geom_smooth(method='lm', formula=y~x)+
...
# All years
temp_data <- netflix_rating_male

netflix_rating_male_movies_only <- temp_data[
  temp_data$rating == "G" | temp_data$rating == "PG" |
    temp_data$rating == "PG-13" | temp_data$rating == "R",] %>%
ggplot(aes(x=gender_rato_percentage, y=tomatometer_rating, color=rating)) +
  geom_point()+
  geom_smooth(method='lm', formula=y~x)+
  labs(title="Male cast-ratio vs RT rating: all years (Movie rating)", x="male cast-ratio", y="RT rating")


netflix_rating_male_tv_only <- temp_data[
  temp_data$rating == "TV-14" | temp_data$rating == "TV-G" |
    temp_data$rating == "TV-MA" | temp_data$rating == "TV-PG" |
    temp_data$rating == "TV-Y7",] %>%
ggplot(aes(x=gender_rato_percentage, y=tomatometer_rating, color=rating)) +
  geom_point()+
  geom_smooth(method='lm', formula=y~x)+
...
#2015-2020
temp_data <- netflix_rating_male_2015_to_2020
...
#2010-2015
temp_data <- netflix_rating_male_2010_to_2015
...
#2005-2010
temp_data <- netflix_rating_male_2005_to_2010
