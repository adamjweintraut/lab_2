...
# netflix_tomatoes_cast_dataset <- netflix_tomatoes_cast_dataset[netflix_tomatoes_cast_dataset$country == "United States",]
...
hist(netflix_gender_ratio$tomatometer_rating)
hist(netflix_gender_ratio$gender_rato_percentage)

netflix_gender_ratio_90_100 <- netflix_gender_ratio[
  netflix_gender_ratio$gender_rato_percentage >= 90 & netflix_gender_ratio$gender_rato_percentage < 100,]

hist(netflix_gender_ratio_90_100$tomatometer_rating)
hist(netflix_gender_ratio_90_100$gender_rato_percentage)

netflix_gender_ratio_80_90 <- netflix_gender_ratio[
  netflix_gender_ratio$gender_rato_percentage >= 80 & netflix_gender_ratio$gender_rato_percentage < 90,]

hist(netflix_gender_ratio_80_90$tomatometer_rating)
hist(netflix_gender_ratio_80_90$gender_rato_percentage)

netflix_gender_ratio_70_80 <- netflix_gender_ratio[
  (netflix_gender_ratio$gender_rato_percentage >= 70) & (netflix_gender_ratio$gender_rato_percentage < 80),]

hist(netflix_gender_ratio_70_80$tomatometer_rating)
hist(netflix_gender_ratio_70_80$gender_rato_percentage)

netflix_gender_ratio_60_70 <- netflix_gender_ratio[
  (netflix_gender_ratio$gender_rato_percentage >= 60) & (netflix_gender_ratio$gender_rato_percentage < 70),]
hist(netflix_gender_ratio_60_70$tomatometer_rating)
hist(netflix_gender_ratio_60_70$gender_rato_percentage)

netflix_gender_ratio_50_60 <- netflix_gender_ratio[
  (netflix_gender_ratio$gender_rato_percentage >= 50) & (netflix_gender_ratio$gender_rato_percentage < 60),]
hist(netflix_gender_ratio_50_60$tomatometer_rating)
hist(netflix_gender_ratio_50_60$gender_rato_percentage)

netflix_gender_ratio_40_50 <- netflix_gender_ratio[
  (netflix_gender_ratio$gender_rato_percentage >= 40) & (netflix_gender_ratio$gender_rato_percentage < 50),]
hist(netflix_gender_ratio_40_50$tomatometer_rating)
hist(netflix_gender_ratio_40_50$gender_rato_percentage)

netflix_gender_ratio_30_40 <- netflix_gender_ratio[
  (netflix_gender_ratio$gender_rato_percentage >= 30) & (netflix_gender_ratio$gender_rato_percentage < 40),]
hist(netflix_gender_ratio_30_40$tomatometer_rating)
hist(netflix_gender_ratio_30_40$gender_rato_percentage)

netflix_gender_ratio_20_30 <- netflix_gender_ratio[
  (netflix_gender_ratio$gender_rato_percentage >= 20) & (netflix_gender_ratio$gender_rato_percentage < 30),]
hist(netflix_gender_ratio_20_30$tomatometer_rating)
hist(netflix_gender_ratio_20_30$gender_rato_percentage)

netflix_gender_ratio_10_20 <- netflix_gender_ratio[
  (netflix_gender_ratio$gender_rato_percentage >= 10) & (netflix_gender_ratio$gender_rato_percentage < 20),]
hist(netflix_gender_ratio_10_20$tomatometer_rating)
hist(netflix_gender_ratio_10_20$gender_rato_percentage)

netflix_gender_ratio_0_10 <- netflix_gender_ratio[
  (netflix_gender_ratio$gender_rato_percentage >= 0) & (netflix_gender_ratio$gender_rato_percentage < 10),]
hist(netflix_gender_ratio_0_10$tomatometer_rating)
hist(netflix_gender_ratio_0_10$gender_rato_percentage)
```
...
# movies_lead_actor <- read.csv("datasets/movies.csv")
...
plot_scatterplot <- function(dataset, title) {
  #All years
  plot(ggplot(data=dataset, aes(gender_rato_percentage, tomatometer_rating))+
    geom_point()+
    geom_smooth(method='lm', formula=y~x)+
    labs(title=title, x="male cast-ratio", y="RT rating"))
...
# cor(netflix_gender_ratio)

#PG has a strong 
#TV-MA


plot_scatterplot(netflix_gender_ratio, "Male cast-ratio vs RT rating")


temp_data <- netflix_gender_ratio[netflix_gender_ratio$rating == "PG",]
NROW(temp_data)
plot_scatterplot(temp_data, "Male cast-ratio vs RT rating: PG")

temp_data <- netflix_gender_ratio[netflix_gender_ratio$rating == "PG-13",]
NROW(temp_data)
plot_scatterplot(temp_data, "Male cast-ratio vs RT rating: PG-13")


temp_data <- netflix_gender_ratio[netflix_gender_ratio$rating == "R",]
NROW(temp_data)
plot_scatterplot(temp_data, "Male cast-ratio vs RT rating: R")

# lm = lm(tomatometer_rating ~ gender_rato_percentage, temp_data)
# summary(lm)

temp_data <- netflix_gender_ratio[netflix_gender_ratio$rating == "TV-14",]
NROW(temp_data)
plot_scatterplot(temp_data, "Male cast-ratio vs RT rating: TV-14")

temp_data <- netflix_gender_ratio[netflix_gender_ratio$rating == "TV-G",]
NROW(temp_data)
plot_scatterplot(temp_data, "Male cast-ratio vs RT rating: TV-G")

temp_data <- netflix_gender_ratio[netflix_gender_ratio$rating == "TV-MA",]
NROW(temp_data)
plot_scatterplot(temp_data, "Male cast-ratio vs RT rating: TV-MA")

temp_data <- netflix_gender_ratio[netflix_gender_ratio$rating == "TV-PG",]
NROW(temp_data)
plot_scatterplot(temp_data, "Male cast-ratio vs RT rating: TV-PG")

temp_data <- netflix_gender_ratio[netflix_gender_ratio$rating == "TV-Y7",]
NROW(temp_data)
plot_scatterplot(temp_data, "Male cast-ratio vs RT rating: TV-Y7")



# lm = lm(tomatometer_rating ~ gender_rato_percentage, tv_ma)
# summary(lm)
...
# critics <- read.csv("datasets/rotten_tomatoes_critic_reviews.csv")

critics_cleaned <- filter(critics, critics$critic_name != "") %>% 
  group_by(critic_name) %>% 
  summarise(count_critics = n())

critics_cleaned <- critics_cleaned[order(-critics_cleaned$count_critics),]

critic_roger_ebert <- filter(critics, critics$critic_name == "Roger Ebert")
critic_roger_ebert <- filter(critic_roger_ebert, critic_roger_ebert$review_score != "")

critic_roger_ebert <- critic_roger_ebert %>% 
  mutate(rating_percetange = strsplit(review_score, "/")) %>% 
  mutate(rating_percetange_2 = rating_percetange[1][1])
...
typeof(critic_roger_ebert$rating_percetange[1])

# critic_roger_ebert$rating_percetange

# %>%
  # mutate(rating_percetange = rating_percetange[0])
