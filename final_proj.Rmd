...
# lm = lm(log(gross) ~ female_indicator + log(budget) + log(title_unique_score), movies_dataset)

# model_3a = lm(log(gross) ~ log(title_unique_score), movies_dataset)
# stargazer(
#   model_3a,
#   header=FALSE,
#   type='latex',
#   se = list(get_robust_se(model_3a))
#   )
```
