...
After introducing the genre categorical indicators into our second model, most of them have a p-value less that 0.01, except for "is_genre_drama". Coefficients for both female_indicator and budget have been reduced, but remain significant.Adjusted R-square of the model has also improved to 0.505.
