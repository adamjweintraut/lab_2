...
model_1 <- lm(log(gross) ~ female_indicator + log(budget), movies_dataset)
model_2 <- lm(log(gross) ~ female_indicator + log(budget) + runtime, movies_dataset)
model_3 <- lm(log(gross) ~ female_indicator + log(budget) + runtime + log(title_unique_score), movies_dataset)
